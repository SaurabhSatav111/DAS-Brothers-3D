        ...
        <div className="footer-grid">
          ...
          <div>
            <a href="#home" className="flex items-center gap-2.5" style={{ textDecoration: 'none' }}>
              ...
              <span style={{ fontFamily: "'Playfair Display', serif", fontSize: '1.3rem', color: '#ffffff', fontWeight: 700 }}>
                DAS & BROTHERS
              </span>
            </a>
            <p style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: '0.88rem', color: 'var(--dark-muted)', marginTop: '0.5rem', lineHeight: '1.6' }}>
          ...
          {/* Column 3 — Contact snippet & Licensing */}
          <div>
            <span style={{ fontFamily: "'Playfair Display', serif", fontSize: '1.05rem', color: '#ffffff', fontWeight: 700, display: 'block', marginBottom: '1rem' }}>
              Contact & Licensing
            </span>
