    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col gap-24">
        {details.map((detail, index) => {
          ...
          return (
            <div key={detail.id} className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div
                ...
                style={{ border: `1.5px solid ${detail.accentColor}30` }}
              >
                <div
                ...
                >
                  <span className="w-1.5 h-1.5 rounded-full" style={{ background: detail.accentColor }} />
                  {detail.imageLabel}
                </div>
