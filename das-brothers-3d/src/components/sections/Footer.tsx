  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2">
                ...
                <a href="tel:+912027491987" style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: '0.9rem', color: '#a0aec0', textDecoration: 'none', transition: 'color 0.3s' }} className="hover:text-[#E87722]">
                  +91 20 2749 1987
                </a>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="mailto:info@dasbrothers.co.in" style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: '0.9rem', color: '#a0aec0', textDecoration: 'none', transition: 'color 0.3s' }} className="hover:text-[#E87722]">
        ...
        <div style={{ textAlign: 'center', fontSize: '0.8rem', color: '#a0aec0', paddingTop: '1.5rem' }}>
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6">
              <a
                ...
                style={{ textDecoration: 'none', color: '#a0aec0', display: 'inline-flex', alignItems: 'center', gap: '0.35rem', transition: 'color 0.3s ease' }}
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                style={{ textDecoration: 'none', color: '#a0aec0', display: 'inline-flex', alignItems: 'center', gap: '0.25rem', transition: 'color 0.3s ease' }}
                className="hover:text-[#E87722]"
              >
